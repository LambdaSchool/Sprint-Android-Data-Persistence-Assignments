...
class JournalEntry : Serializable {
    ...
    //this gives us an object that we can write into the file repo
    fun toJsonObject(): JSONObject? {
        try {
            ...
            return try {
                JSONObject("{\"date\": \"$date\", \"entry_text\": \"$entryText\", \"image\": \"$image\", $dayRating, $id}")
    ...
    private fun initializeDate() {
        ...
        //this.date = dateFormat.format(date) to ->
        this.date = (date.time/1000).toString()
